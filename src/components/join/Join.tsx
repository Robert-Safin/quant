...
const Join = () => {
  return (
    <div className="relative flex flex-col md:flex-row  my-8 w-fit max-w-[1280px] mx-auto justify-center md:items-start items-center space-y-8 px-5 md:justify-between">
      ...
      <h1 className="primaryHeader text-center md:text-left md-w-1/2 md:max-w-[300px]">
        Join Quant Team
      </h1>
      <div className="md:w-1/2">
        ...
        <p className="text text-center md:text-left md:max-w-[600px]">
          As we emphasize it in our name – Quant Team, we are a team. A team
